...
import { createUserSchema, userSignInschema } from "../schemas/user.schema.js";
import { validator } from '../middlewares/validator.middleware.js'

const router = express.Router();

router.post('/signup'/* , validator(userSignInschema)  */,accountExistSigup, authController.signup)
